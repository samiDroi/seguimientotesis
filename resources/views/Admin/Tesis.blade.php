...
<div class="container">
    ...
    <div class="enlace-a-left mt-4">
        <a class="text-decoration-none" href="{{ Route('tesis.review') }}">
            <i class="fa-solid fa-arrow-left-long"></i> Panel de revisión de tesis
        </a>
    </div>
                        ...
                        <div class="col-12 text-center">
                            @foreach ($tesisComites as $tesisComite)
                                @if ($tesisComite->id_tesis == $tesis->id_tesis)
                                    ...
                                    @else
                                        <p class="text-danger">No hay capítulos para esta tesis.</p>
                                    @endif
                                @endif
                            @endforeach
                        </div>
